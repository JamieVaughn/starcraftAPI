...
$(document).ready(function(){
	...
	if (!isMobile) {
		$('#video_thumb').click(function() {
			$('#video_thumb').replaceWith('<iframe id="video" width="960" height="540" src="https://www.youtube.com/embed/8UyMAPr-G44?autoplay=1&vq=hd1080p60" frameborder="0" allowfullscreen></iframe>');
			return false;
		});
	} else {
...
function onScroll() {
	...
	if (!isios) {
		...
		var startColor = {r:164, g: 77, b: 114};
		var endColor = {r:39, g: 22, b: 56};
